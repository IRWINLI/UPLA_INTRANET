<div class="contenedor_cuerpo">
    <fieldset>
        <p class="titulo_modulo">ACTIVACIÓN DE RECTIFICACIÓN ADICIONAL</p>
        ...
        <div id="div_datosEstudiante" style="display:none">
            ...
            <div class="CSSdatosEst_2">
                ...
                <button class="css_btn" onclick="activarRectificacionAdicional()" id="btnAmpliarCreditos" >RECTIFICAR</button>
