            ...
            success : function(data) 
            {
                ...
                if (pagoMatriculaArr[n]=='NO PAGO') {
                    ...
                    if (estaMatriculadoArr[n]==1) {
                        ...
                        alerta("Este alumno ya está matriculado, sólo tendrá acceso a la CONSTANCIA DE MATRÍCULA.");
...
//=========================================================================================================
    function imprimirCursosSelectos(){
    setTimeout(function(){
        $("#tabla_cursosEstudiante tr").remove();
        nuevaFila = document.getElementById("tabla_cursosEstudiante").insertRow(-1);
        nuevaFila.innerHTML ='<th style="font-size: 14px;font-weight: bold;">Nivel</th><th style="font-size: 14px;font-weight: bold;">Código</th><th style="font-size: 14px;font-weight: bold;">Asignatura</th><th style="font-size: 14px;font-weight: bold;">Créditos</th><th style="font-size: 14px;font-weight: bold;">Turno</th><th style="font-size: 14px;font-weight: bold;">Quitar</th>';
