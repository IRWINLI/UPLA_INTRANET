<div class="contenedor_cuerpo">
    ...
    <br>
    <p class="titulo_módulo" style="color:blue;">MATRÍCULA POR CONVALIDACIONES</p>
    <div id="div_buscarAlumno"><a href="matricula_convalidacion" >Nueva Búsqueda</a></div>
    ...
    <div class="capa_CursosEstudiante">
        ...
        <div class="CSSTableGenerator_small" >
            ...
            <div id="div_matricular"><a href="javascript:matricular()" >Ejecutar Matricular</a></div>
                ...
                if (rpta) {
                    ...
                    var params={};
                        ...
                        $.ajax({
                            data : params,
                            type: "POST",
                            url: "ejecutarMatricula_Convalidacion",
                            dataType: "json",
