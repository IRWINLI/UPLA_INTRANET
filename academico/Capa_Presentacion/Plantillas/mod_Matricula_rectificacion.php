<div class="contenedor_cuerpo">
    ...
    <br>
    <p class="titulo_módulo" style="color:red">RECTIFICACIÓN DE MATRÍCULA DE ESTUDIANTES</p>
    <div id="div_buscarAlumno"><a href="matricula_rectificacion" >Nueva Búsqueda</a></div>
    ...
    <div class="capa_CursosEstudiante">
        ...
        <div class="CSSTableGenerator_small" >
            ...
            <div id="div_matricular"><a href="javascript:matricularRectificacion()" >Rectificar Matricular</a></div>
...
<script>
    ...
    function matricularRectificacion() {
        ...
        if (parseInt(Creditos_Matricular)>parseInt(MaximoCreditos_Matricular)) {
            ...
            for(var i=0;i<codigoAsignatura.length;i++){
                ...
                if (selecAsignatura[i]==true){
                    ...
                    if (turnSeleccionados[j]==0 || curSalSeleccionados[j]==0 || typeof(curSalSeleccionados[j])=='undefined'){
                ...
                if (rpta) {
                    ...
                    var params={};
                        ...
                        $.ajax({
                            data : params,
                            type: "POST",
                            url: "rectificarMatricula",
                            dataType: "json",
                            success : function(data){
                                
                                ocultarCargando();//========= Mostrar "Cargando"
                                if (data["rpta"]=="La Matricula fue rectificada correctamente"){
