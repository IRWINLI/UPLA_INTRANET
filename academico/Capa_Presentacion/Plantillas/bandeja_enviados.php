<div class="contenedor_cuerpo">    
     ...
     <p class="titulo_módulo">ENVIADOS</p>
        ...
        <div>            
            ...
            <button class="button button-flat-primary"  name="btn_busseg" id="btn_busseg" onclick="buscar_enviados();">Buscar</button>          
        </div>
        <br>
    ...
    <input type="hidden" name="cant_filas_envs" id="cant_filas_envs" value="0"/>
