...
.ui-widget input, .ui-widget select, .ui-widget textarea, .ui-widget button { font-family: Verdana,Arial,sans-serif; font-size: 18px; }
.ui-widget-content { border: 1px solid #888; background: #fcfdfd url(images/ui-bg_inset-hard_100_fcfdfd_1x100.png) 50% bottom repeat-x; color: #0D0B6B;}
.ui-widget-content a { color: #222222; }
.ui-widget-header {     border: 1px solid #888;
    background: url('images/ui-bg_gloss-wave_75_2191c0_500x100.png') repeat-x scroll 50% 50% rgba(81, 171, 255, 1);
    color: #EAF5F7;
    font-weight: bold;}
...
/* Progressbar
----------------------------------*/
.ui-progressbar { height:18px; text-align: left; }
