...
<script>
    ...
    function comprobarRequisito(){
        ...
        var params={};
        params['codEst']="<?php echo $_POST['codEst'] ?>";
        //FALTA!!!!!!!!!!!!!!!!!!!!
        mostrarCargando();
        $.ajax({
            data : params,
            type: "POST",
            url: "requisitosMatriculaManual",
            dataType: "json",
    ...
    function continuarRequisitos(){
        ...
        if (continuar)
        {
            ...
            */
            ...
            params['codEst']="<?php echo $_POST['codEst'] ?>";
            redirect_by_post("matriculaManualPlanEstudios",params, false);
    ...
    function detalleRequisito(idRequisito){
        ...
        if (idRequisito=='r_pago') {
            ...
            $('#enlace_cuadroDialogo').attr("href","fseco-adm?col=rgb(236,%2052,%2052)&col_sombra=rgb(182,%2041,%2041)&sistema=10&letra=rgb(185,%20166,%20155)");
