...
class JdbcConnection {
	...
	public function __construct($bd){
		...
		$this->connection->setDriver("com.microsoft.sqlserver.jdbc.SQLServerDriver");
		$this->connection->setConnectString("jdbc:sqlserver://172.16.0.10:1433;databaseName=".$bd);
		//$this->connection->setConnectString("jdbc:sqlserver://172.16.0.10:1433;databaseName=DBCampusNet");
		$this->connection->setUser("conn_desarrollo");
		$this->connection->setPassword("DESARROLLO");
